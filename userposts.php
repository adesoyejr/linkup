...
<div class="content" style="background-color:white; opacity:1;">
            <div class="container-fluid">
                <div class="row">                                                 
                    <div class="col-lg-12">
                        <h4 class="title"><?php echo "$thisuser's Posts"?></h4>
                        <hr>

                        
                            <?php 
                            $sql = "SELECT * FROM post INNER JOIN user on post.sender = user.username WHERE post.sender = '$thisuser' AND post.parentid is NULL ORDER BY posttime DESC LIMIT 30";

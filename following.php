...
<div class="col-lg-6">
    <div class="modal-content animated fadeIn slower">
        ...
        <center><h5><b>FOLLOWING</b></h5></center>
        <div class="modal-body">
        <?php 
            $sql = "SELECT * FROM follow INNER JOIN user ON follow.followed=user.username WHERE follow.follower= '$thisuser' ORDER BY followtime";
    ...
    <div class="modal-content animated fadeIn slower">
        ...
        <?php 
            ...
            $people = "SELECT * FROM user INNER JOIN follow ON follow.followed=user.username WHERE follow.follower <> '$thisuser' AND user.username <> '$thisuser' ORDER BY followtime";
